...
NAME = "GOAL_FUNCTION_COMPONENTS"
AMOUNT_OF_FIELDS = 8
AMOUNT_OF_GROUPS_IN_FIELD = [4]
SUBJECTS_PER_FIELD = [5]
AMOUNT_OF_STUDENTS_PER_GROUP = [30]
AMOUNT_OF_LECTURERS = 16
AMOUNT_OF_BUILDINGS = 2
DISTANCES_BETWEEN_BUILDINGS = [5, 10]
AMOUNT_OF_LAB_ROOMS = [4]
AMOUNT_OF_LECT_ROOMS = [2]
